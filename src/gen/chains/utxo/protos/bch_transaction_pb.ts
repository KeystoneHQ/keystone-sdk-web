...
// @generated from file chains/utxo/protos/bch_transaction.proto (package protoc, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 */
export class BchTx extends Message<BchTx> {
  /**
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): BchTx {
    return new BchTx().fromBinary(bytes, options);
  }
  ...
  static equals(a: BchTx | PlainMessage<BchTx> | undefined, b: BchTx | PlainMessage<BchTx> | undefined): boolean {
    return proto3.util.equals(BchTx, a, b);
  }
}
 ...
 */
export class BchTx_Input extends Message<BchTx_Input> {
  /**
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): BchTx_Input {
    return new BchTx_Input().fromBinary(bytes, options);
  }
  ...
  static equals(a: BchTx_Input | PlainMessage<BchTx_Input> | undefined, b: BchTx_Input | PlainMessage<BchTx_Input> | undefined): boolean {
    return proto3.util.equals(BchTx_Input, a, b);
  }
}
